...
contract Tracking{
    ...
    public payable{
        ...
        Shipment memory shipment = Shipment(msg.sender, _receiver, _pickupTime, 0, _distance,
    ...
    function startShipment(address _sender, address _receiver, uint256 _index) public{
        ...
        require(shipment.status == ShipmentStatus.PENDING, "Shipment aready in transit");
    ...
    function completeShipment(address _sender, address _receiver, uint256 _index) public
    {
        ...
        emit ShipmentDelivered(_sender, _receiver, shipment.pickupTime, shipment.deliveryTime);
    }
