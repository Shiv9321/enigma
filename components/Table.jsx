export default ( { setCreateShipmentModel, allShipmentsdata }) =>
{
  ...
  // if (allShipmentsdata) return <div>Loading...</div>;

  return(
    <div className="max-w-screen--xl x-auto px-4 md:px-8">
         ...
         <div className="mt-3 md:mt-0">
            {/* <p
              ...
              <button
                ...
                className="mt-3 px-4 py-2 text-white bg-gray-800 hover:bg-gray-700
                        active:bg-gray-900 rounded-lg text-sm font-medium md:mt-0"
                  >
                    Add Tracking
            </button>
          </div>
